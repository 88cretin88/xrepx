...
export MAKE_J="10"
export C_COMPILER="gcc-7"
export CXX_COMPILER="g++-7"

export CFLAGS_X32="-march=nehalem -O2"
export CFLAGS_X64="-march=nehalem -O2"
export LDFLAGS_X32="${CFLAGS_X32}"
export LDFLAGS_X64="${CFLAGS_X64}"

export CROSSCFLAGS_X32="-march=nehalem -O2"
export CROSSCFLAGS_X64="-march=nehalem -O2"
export CROSSLDFLAGS_X32="${CROSSCFLAGS_X32}"
export CROSSLDFLAGS_X64="${CROSSCFLAGS_X64}"

export WINE_BUILD_OPTIONS="--without-oss --disable-win16 --disable-tests --without-sane --without-gphoto --without-pulse --without-curses" #--without-gstreamer"

export WINE_VERSION_NUMBER="$1"

rm -fr "$MAINDIR/sources_dir"
...
create_build_scripts () {
	...
	echo 'make depend' >> $MAINDIR/build32.sh
	echo "make -j${MAKE_J}" >> $MAINDIR/build32.sh
	...
	echo 'make depend' >> $MAINDIR/build64.sh
	echo "make -j${MAKE_J}" >> $MAINDIR/build64.sh
